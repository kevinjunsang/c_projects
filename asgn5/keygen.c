...
int main(int argc, char **argv) {
	...
	while ((opt = getopt(argc, argv, "b:i:n:d:s:vh")) != -1) {
		...
		case 'n': pbfile = fopen(optarg, "w+"); file_1 = false; break;
		case 'd': pvfile = fopen(optarg, "w+"); file_2 = false; break;
	...
	if (H == true) {
		fprintf(stderr, "SYNOPSIS\n"
				...
				"\n"
				"USAGE\n"
				"     ./keygen [b:i:n:d:s:vh] [-b bits] [-i iters] [-n pubfile] [-d privfile] [-s seed]\n"
				"\n"
				"OPTIONS\n"
